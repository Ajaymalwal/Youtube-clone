...
const Drawerslidebar = ({ toggledrawer, toggledrawersidebar }) => {
  return (
    <>
            ...
            <div className="icon_sidebar_div">
              <p>
                <MdOutlineExplore
                  ...
                  style={{ margin: "auto 0.7rem" }}
                />
                <div className="text_siebar_icon">Explore</div>
              </p>
            </div>
            <div className="icon_sidebar_div">
              <p>
                <img
                  ...
                  style={{ margin: "auto 0.7rem" }}
                />
                <div className="text_siebar_icon">Shorts</div>
              </p>
            </div>
            <div className="icon_sidebar_div">
              <p>
                <MdSubscriptions
                  ...
                  style={{ margin: "auto 0.7rem" }}
                />
                <div className="text_siebar_icon">Subscription</div>
              </p>
            </div>
          </div>
